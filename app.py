...
def param_row(label, slider_id, min_val, max_val, step, value, unit, marks=None):
    return html.Div(className="param-group", children=[
        html.Div(dcc.Input(value=label, className="param-label-input"), className="param-label"),
        html.Div(className="param-value-wrap", children=[
            dcc.Input(
            ...
            html.Span(unit, className="param-unit")
        ]),
        dcc.Slider(
            id=slider_id,
    ...
    html.Main(className="main-content", children=[
        ...
        html.Div(className="param-grid", children=[
            ...
            html.Div(className="glass-card", children=[
                html.Div(className="param-card-title tank-a-title", children=[
                    html.Span("🟦 "),
                    dcc.Input(value="Tank A — Moisture-Lean Biomass", className="group-title-input")
                ]),
            ...
            # Tank B
            html.Div(className="glass-card", children=[
                html.Div(className="param-card-title tank-b-title", children=[
                    html.Span("🟩 "),
                    dcc.Input(value="Tank B — Moisture-Rich Biomass", className="group-title-input")
                ]),
            ...
            # Gas Turbine
            html.Div(className="glass-card", children=[
                html.Div(className="param-card-title turbine-title", children=[
                    html.Span("🟧 "),
                    dcc.Input(value="Gas Turbine Cycle", className="group-title-input")
                ]),
...
for _sid, _unit in _slider_units.items():
    @callback(
        Output(_sid, "value"),
        Output(f"{_sid}-display", "value"),
        Input(_sid, "value"),
        Input(f"{_sid}-display", "value"),
        prevent_initial_call=True,
    )
    def _sync_val(slider_val, input_val, sid=_sid):
        ...
        if trigger_id == sid:
            ...
            # Fallback for None values from input
            val = input_val if input_val is not None else slider_val
            return val, val
